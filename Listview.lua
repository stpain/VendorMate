...
function VendorMateListviewMixin:OnElementInitialize(element, elementData, isNew)
    if isNew then
        element:OnLoad();
    end
    local height = self.elementHeight;
...
function VendorMateListviewMixin:OnElementReset(element)
