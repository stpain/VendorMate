...
VendorMateDropDownTemplateMixin = {}

function VendorMateDropDownTemplateMixin:OnLoad()
    self.isOpen = false;
...
function VendorMateDropDownTemplateMixin:SetWidth(width)
    --self.flyout:SetWidth(width)
end

function VendorMateDropDownTemplateMixin:SetText(text)
    self.label.text:SetText(text)
end

function VendorMateDropDownTemplateMixin:ClearMenu()
    self.flyout.listview.DataProvider:Flush()
end

function VendorMateDropDownTemplateMixin:SetMenu(t)
...
VendorMateDropDownListviewItemTemplateMixin = {}

function VendorMateDropDownListviewItemTemplateMixin:OnLoad()
    self.dropdown = self:GetParent():GetParent():GetParent():GetParent():GetParent()
end

function VendorMateDropDownListviewItemTemplateMixin:SetDataBinding(binding, height)
...
function VendorMateDropDownListviewItemTemplateMixin:ResetDataBinding()
